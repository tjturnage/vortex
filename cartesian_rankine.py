...
class VortexGrid2:
    ...
    def convergence_V_contour_plot(self):
        levels = np.arange(-2.01, 2.01, 0.2)
        cn = self.contour_plot(self.convergence_V,red_black_blue,levels,1)
        return cn
    ...
    def convergence_V_full_contour_plot(self):
        cv = self.do_contour_plot(self.convergence_V_full,red_black_blue,1)
        return cv
